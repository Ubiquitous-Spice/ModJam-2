...
public class EntityGiantItem extends Entity
{
    ...
    public EntityGiantItem(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.health = 5;
        this.hoverStart = (float)(Math.random() * Math.PI * 2.0D);
        this.setSize(0.25F * EntityLargeSheep.largeSheepMod, 0.25F * EntityLargeSheep.largeSheepMod);
    ...
    public EntityGiantItem(World par1World, double par2, double par4, double par6, ItemStack par8ItemStack)
    {
     ...
     */
    public boolean combineItems(EntityGiantItem par1EntityItem)
    {
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.delayBeforeCanPickup <= 0 && (i <= 0 || par1EntityPlayer.inventory.addItemStackToInventory(itemstack)))
            {
