...
public class RenderGiantItem extends Render
{
            ...
            else
            {
                ...
                if (itemstack.getItemSpriteNumber() == 1 && itemstack.getItem().requiresMultipleRenderPasses())
                {
                    ...
                    for (int k = 0; k < itemstack.getItem().getRenderPasses(itemstack.getItemDamage()); ++k)
                    {
                        ...
                        {
                            this.renderDroppedItem(item, icon, b0, par9, 1.0F, 1.0F, 1.0F, k);
                        }
                    }
                }
                else
                {
                    ...
                    {
                        this.renderDroppedItem(item, icon1, b0, par9, 1.0F, 1.0F, 1.0F);
                    }
                }
            }
     ...
     */
    private void renderDroppedItem(EntityGiantItem item, Icon par2Icon, int par3, float par4, float par5, float par6, float par7)
    {
