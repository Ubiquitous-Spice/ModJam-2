...
public class RenderConfusedVillager extends RenderBiped
{
    ...
    public RenderConfusedVillager()
    {
        ...
        this.field_82432_p = new ModelConfusedVillager();
    }
    ...
    {
        this.func_82428_a((EntityConfusedVillager) par1EntityLiving, par2);
    }

    protected ResourceLocation func_110856_a(EntityLiving par1EntityLiving)
    {
        return this.func_110863_a((EntityConfusedVillager) par1EntityLiving);
    }

    public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
    {
        this.func_82426_a((EntityConfusedVillager) par1EntityLiving, par2, par4, par6, par8, par9);
    }

    protected int func_130006_a(EntityLiving par1EntityLiving, int par2, float par3)
    {
        return this.func_82429_a((EntityConfusedVillager) par1EntityLiving, par2, par3);
    }
    ...
    {
        return this.func_82429_a((EntityConfusedVillager) par1EntityLivingBase, par2, par3);
    }

    protected void renderEquippedItems(EntityLivingBase par1EntityLivingBase, float par2)
    {
        this.func_82428_a((EntityConfusedVillager) par1EntityLivingBase, par2);
    }

    protected void rotateCorpse(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4)
    {
        this.func_82430_a((EntityConfusedVillager) par1EntityLivingBase, par2, par3, par4);
    }

    public void renderPlayer(EntityLivingBase par1EntityLivingBase, double par2, double par4, double par6, float par8, float par9)
    {
        this.func_82426_a((EntityConfusedVillager) par1EntityLivingBase, par2, par4, par6, par8, par9);
    }

    protected ResourceLocation func_110775_a(Entity par1Entity)
    {
        return this.func_110863_a((EntityConfusedVillager) par1Entity);
    }
    ...
    {
        this.func_82426_a((EntityConfusedVillager) par1Entity, par2, par4, par6, par8, par9);
    }
}
